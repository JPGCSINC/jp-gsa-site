  ...
  return (
    <div className="p-6 space-y-12">
      <section className="text-center space-y-4">
        <h1 className="text-4xl font-bold">JP Government Contract Services, Inc.</h1>
      ...
      <section className="grid md:grid-cols-3 gap-6">
        <Card>
          <CardContent className="p-4">
            <h2 className="text-xl font-semibold mb-2">MAS Contract Setup</h2>
            <p>End-to-end support for first-time GSA MAS offers, tailored to small businesses.</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <h2 className="text-xl font-semibold mb-2">FAS Catalog Transition</h2>
            <p>Streamlined help for service-based contractors transitioning to the FCP system.</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <h2 className="text-xl font-semibold mb-2">Contract Mods & Strategy</h2>
